...
const BottomModal = memo((props)=>{
    ...
    const [localCheckedTicketTypes,localCheckedTicketTypesDispatch] = useReducer(
        checkedReducer,
        checkedTicketTypes,
        (checkedTicketTypes)=>{return {...checkedTicketTypes}
    });
    ...
    const resetClass = classnames('reset',{
        ...
        <div className="bottom-modal">
            <div className="bottom-dialog">
                <div className="bottom-dialog-content">
                    <div className="title">
                        <span className={resetClass} onClick={reset}>
                            重置
                        </span>
...
export default function Bottom(props){
    ...
    const dclasses = classnames('item',{
        'item-on':highSpeed
    })
    const dTclasses = classnames('item',{
        'item-on':onlyTickets
    })
